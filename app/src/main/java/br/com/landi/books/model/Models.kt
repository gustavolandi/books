...
data class Read(val id: Long = 0, val titleBook : String? = "", val authorName: String? = "", val idBook: Long = 0, val startedDate : String?, val finishedDate : String?, val status : StatusRead, val genreList : MutableList<String> = mutableListOf()) {
}
